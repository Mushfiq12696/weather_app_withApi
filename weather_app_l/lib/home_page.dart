...
class _HomePageState extends State<HomePage> {
  ...
  fetchWeatherData() async {
    String weatherAPI =
        "https://api.openweathermap.org/data/2.5/weather?lat=${position!.latitude}&lon=${position!.longitude}&appid=337329ae3b952e615f69dfb3af221374";

    String forecastAPI =
        "https://api.openweathermap.org/data/2.5/forecast?lat=${position!.latitude}&lon=${position!.longitude}&appid=337329ae3b952e615f69dfb3af221374";
  ...
  Widget build(BuildContext context) {
    if (weatherMap == null) {
      ...
      return SafeArea(
        child: Scaffold(
          backgroundColor: Color.fromARGB(255, 90, 139, 237),
                              ...
                              return SizedBox(
                                ...
                                child: Column(children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Card(
                                      color: Color.fromARGB(255, 240, 228, 223),
                                      shape: RoundedRectangleBorder(
                                          borderRadius:
